...
<html lang="es" class="no-js">
    <head>
        <meta charset="utf-8" />
        <title>Nicaventura - Videos Granada</title>
        ...
        <div class="main">
			<div class="shell">
                ...
                <div style="margin-top: 30px; padding-top: 30px;"></div>
                  ...
                  <div class="Videos">                       
   <video id="Granada03" class="video-js vjs-default-skin" controls
 preload="auto" width="640" height="320" poster="Fotografias/Granada/DSCN0569.JPG"
 data-setup="{}">
 <source src="Video/Granada03.mp4" type='video/mp4'/>
...
$IDFoto3 = 'Granada03.mp4';

$datos3 = mysql_query("SELECT Descripcion FROM Descripcion_Video where (ID_Video = '$IDFoto3') and (Departamento = 'Granada') ");
...
?>
 ...
 if($_SESSION["Privilegio"]='Admin'){?>
        <section>  
         ...
         <input type="hidden" value="Granada03.mp4" name="FotoName" />
         <input type="hidden" value="Granada" name="Depart" />
...
<section>  
         ...
         <input type="hidden" value="<?php echo 'Granada03.mp4';?>" name="FotoName" />
         <input type="hidden" value="Granada" name="Depart" />
        <input type="hidden" value="<?php echo $url="http://".$_SERVER['HTTP_HOST'].":".$_SERVER['REQUEST_URI'];?>" name="Ruta" />
        <input type="submit" name="Gusta" value="Me Gusta" id="Gusta" class ="Gusta" />
                  <label class="Label"><?php    
include_once("Conectar.php"); new Conexion();
$ID_Foto = 'Granada03.mp4';
$result = mysql_query("SELECT Count(ID_MeGustaV) as Contador from MeGusta_Video where (ID_Video = '$ID_Foto')  and (Departamento = 'Granada') and (Estado = 'Activo') ");
...
include_once("Conectar.php"); new Conexion();
$ID_Foto = 'Granada03.mp4';
$result = mysql_query("SELECT Count(ID_NoMeGustaV) as Contador from NoMeGusta_Video where (ID_Video = '$ID_Foto')  and (Departamento = 'Granada') and (Estado = 'Activo')");
$row = mysql_fetch_array($result);
...
include_once("Conectar.php"); new Conexion();
$IDFoto7 = 'Granada03.mp4';


if(!empty($_GET['Ver'])){
$datos8 = mysql_query("SELECT * FROM ComentV_View where (ID_Video = '$IDFoto7') and (Departamento = 'Granada') and (Estado = 'Activo') ORDER BY ID_ComentV DESC");
}
else{
$datos8 = mysql_query("SELECT * FROM ComentV_View where (ID_Video = '$IDFoto7') and (Departamento = 'Granada') and (Estado = 'Activo') ORDER BY ID_ComentV DESC 
LIMIT 3");
...
if(empty($_GET['Ver'])){
    ?>
   <p class="VerComents" style="margin: 0 auto; text-align: center; padding-top: 15px;"><a class ="Link" href="VerTodo.php?Ver=<?php echo substr($_SERVER["SCRIPT_NAME"],strrpos($_SERVER["SCRIPT_NAME"],"/")+1)."?Granada=Videos";?>">Ver Todos Los Comentarios</a></p>
   
 <?php 
}
 else{ ?>
   <p class="VerComents" style="margin: 0 auto; text-align: center; padding-top: 15px;"><a class ="Link" href="OcultarTodo.php?Ver=<?php echo substr($_SERVER["SCRIPT_NAME"],strrpos($_SERVER["SCRIPT_NAME"],"/")+1)."?Granada=Videos";?>">Ocultar Todos Los Comentarios</a></p>   
 ...
 <?php  } 
  ...
  ?>
	...
	<!-- end video3 -->
        ...
        <div class="clear"></div>   
					<div class="box1" >
						<a class="various fancybox.iframe" href="//www.youtube.com/embed/M4jTdChybAQ" onclick="document.body.style.zoom='100%';">
							<img src="Fotografias/Granada/IMG_0266.JPG" alt="Granada, Nic" style="width: 300px; height: 180px;"/>
							<h3>Granada, Nicaragua - thevideosarehere</h3>
						</a>

              
                        <a class="various fancybox.iframe" href="//www.youtube.com/embed/aXTbDvVgdoM" onclick="document.body.style.zoom='100%';">
							<img src="Fotografias/Granada/DSCN0565.JPG" alt="Granada, Nic" style="width: 300px; height: 180px;"/>
							<h3>Visita Granada - FromNicaragua.com</h3>
						</a>
        ...
        <div class="clear"></div>   
					<div class="box1">
                        ...
                        <a class="various fancybox.iframe" href="//www.youtube.com/embed/8nhcqKII-pQ" onclick="document.body.style.zoom='100%';">
							<img src="Fotografias/Granada/IMG_0687.JPG" alt="Granada, Nic" style="width: 300px; height: 180px;"/>
							<h3>Isletas de Granada - America Mia</h3>
						</a>

                        <a class="various fancybox.iframe" href="//www.youtube.com/embed/Col-e-vWkVc" onclick="document.body.style.zoom='100%';">
							<img src="Fotografias/Granada/DSCN0582.JPG" alt="Granada, Nic" style="width: 300px; height: 180px;"/>
							<h3>La Gran Sultana - VisitaNicaragua</h3>
						</a>
